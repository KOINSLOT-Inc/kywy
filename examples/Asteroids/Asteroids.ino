...
::SpriteSheet spriteSheet = ::SpriteSheet(spriteSheetData,spriteHeight*numFrames, spriteHeight, numFrames);
...
public:
  ...
  void handle(::Actor::Message *message) {
    switch (message->signal) {
      ...
      if (yPosition > DISPLAY_HEIGHT - 32 - padding){
        yPosition = DISPLAY_HEIGHT - 32 - padding;
        }

  ...
  void handle(::Actor::Message *message) {
    switch (message->signal) {
      ...
      case Kywy::Events::TICK:
        ...
        if (buttonUpPressed) {
          engine.display.drawCircle((int16_t)(xPosition - 0.5 * shipArea * cos(shipAngle * M_PI / 180.0)), (int16_t)(yPosition + 0.5 * shipArea * sin(shipAngle * M_PI / 180.0)), 4);
          engine.display.drawCircle((int16_t)(trailX), (int16_t)(trailY), 3);
          engine.display.drawCircle((int16_t)(xPosition - 1.5 * shipArea * cos(shipAngle * M_PI / 180.0)), (int16_t)(yPosition + 1.5 * shipArea * sin(shipAngle * M_PI / 180.0)), 2);
        }
